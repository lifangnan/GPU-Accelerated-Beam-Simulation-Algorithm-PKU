...
// for StraightCapillary element
StraightCapillary::StraightCapillary(std::string r_name) : BeamLineElement(r_name, "StraightCapillary"),
  current_(0.0)
{
}
 ...
 * \brief Print parameters.
 */
void StraightCapillary::Print() const
{
  std::cout << GetName() << ": " << GetType() << ", length = " << GetLength() 
    << ", aper = " << GetAperture() << ", Current = " << GetCurrent()
    << ", monitor = " << (IsMonitorOn()? "on" : "off")<< std::endl;
}
 ...
 * \param r_visitor Pointer to a visitor
 */
void StraightCapillary::Accept(Visitor* r_visitor)
{
  r_visitor->Visit(this);
}


// for CurvedCapillary element
CurvedCapillary::CurvedCapillary(std::string r_name) : BeamLineElement(r_name, "CurvedCapillary"),
  current_(0.0), angle_(90), radius_(1.0)
{
}
 ...
 * \brief Print parameters.
 */
void CurvedCapillary::Print() const
{
  std::cout << GetName() << ": " << GetType() << ", length = " << GetLength() 
    << ", aper = " << GetAperture() << ", Current = " << GetCurrent()
    << ", Angle = " << GetAngle() << ", Radius = " << GetRadius()
    << ", monitor = " << (IsMonitorOn()? "on" : "off")<< std::endl;
}
 ...
 * \param r_visitor Pointer to a visitor
 */
void CurvedCapillary::Accept(Visitor* r_visitor)
{
  r_visitor->Visit(this);
}
