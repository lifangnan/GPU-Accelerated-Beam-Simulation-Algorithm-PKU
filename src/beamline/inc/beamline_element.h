...
class StraightCapillary : public BeamLineElement
{
public:
  StraightCapillary(std::string); // type_ = "StraightCapillary"
...
class CurvedCapillary : public BeamLineElement
{
public:
  CurvedCapillary(std::string); // type_ = "CurvedCapillary"
  double GetCurrent() const;
  void SetCurrent(double); 
  double GetAngle() const;
  void SetAngle(double); 
 ...
 */
inline
double StraightCapillary::GetCurrent() const
{
  return current_;
}

inline
void StraightCapillary::SetCurrent(double Current)
{
  current_ = Current;
}
 ...
 */
inline
double CurvedCapillary::GetCurrent() const
{
  return current_;
}

inline
void CurvedCapillary::SetCurrent(double Current)
{
  current_ = Current;
}

inline
double CurvedCapillary::GetAngle() const
{
  return angle_;
}

inline
void CurvedCapillary::SetAngle(double angle)
{
  angle_ = angle;
}

inline
double CurvedCapillary::GetRadius() const
{
  return radius_;
}

inline
void CurvedCapillary::SetRadius(double radius)
{
  radius_ = radius;
}
